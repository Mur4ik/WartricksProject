...
public class MidpointDisplacement {
    public float deepWaterThreshold, shallowWaterThreshold, desertThreshold, plainsThreshold,
            grasslandThreshold, forestThreshold, hillsThreshold, mountainsThreshold;
    ...
    public int[][] getMapOld() {
        ...
        final int height = (hmult * power) + 1;
        // initialize arrays to hold values
        final float[][] map = new float[width][height];
        final int[][] returnMap = new int[width][height];
        int step = power / 2;
        float sum;
        int count;
